        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
              ...
              <form class="form-horizontal" method="POST" action="baptismal_edit.php?year=<?=$year;?>" enctype="multipart/form-data">
          		  <div class="row">
                ...
                <div class="col-sm-2">
          		  <div class="form-group">
                  	<label for="firstname" class="control-label">RECORD NO.</label>
                    	<input type="text" class="form-control" value="<?=$RECORD_NUMBER;?>" name="RECORD_NUMBER" placeholder="Record No." required>
                  	</div>
                </div>
                ...
                <div class="col-sm-2">
          		  ...
          		  <div class="form-group">
                  	<label for="firstname" class="control-label">CHILD NAME</label>
                    	<input type="text" class="form-control" value="<?=$CHILD_NAME;?>" name="CHILD_NAME" placeholder="Child Name">
                  	</div>
                </div>
                <div class="col-sm-6">
          		  <div class="form-group">
                ...
                <div class="col-sm-6">
          		  <div class="form-group">
                  	<label for="firstname" class="control-label">PLACE OF BIRTH</label>
                    	<input type="text" class="form-control"  value="<?=$PLACE_OF_BIRTH;?>" name="PLACE_OF_BIRTH" placeholder="Place of Birth">
                  	</div>
                </div>
                <div class="col-sm-6">
          		  <div class="form-group">
                ...
                <div class="form-group">
                      ...
                      <!---<textarea rows="8" class="form-control summernote " name="PERMANENT_ADDRESS" placeholder="Address" required><?=$PERMANENT_ADDRESS;?></textarea>---->
                  
                      <input type="text" class="form-control"  value="<?=$PERMANENT_ADDRESS;?>" name="PERMANENT_ADDRESS" placeholder="Address">
                    </div>
                </div>
                <div class="col-sm-6">
                <div class="form-group">
                ...
                <div class="col-sm-6">
                <div class="form-group">
                  	<label for="address" class="control-label">NAME OF PARISH</label>
                      <input type="text" class="form-control" value="<?=$NAME_OF_CHURCH;?>" name="NAME_OF_CHURCH" placeholder="Name of Church">
                  	</div>
                </div>
                <div class="col-sm-6">
          		  <div class="form-group">
              ...
              <a href="baptismal_acView.php?year=<?=$year;?>" class="btn bg-maroon btn-sm"><i class="fa fa-arrow-left"></i> BACK</a>
