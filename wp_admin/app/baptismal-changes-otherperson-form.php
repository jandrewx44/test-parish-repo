    ...
    <section class="content">
      <div class="container-fluid">
		...
		<div class="card card-default">
              ...
              <form role="form" method="POST" action="baptismal-changes-otherperson-form.php">
                <div class="card-body">
             ...
             <div class="embed-responsive embed-responsive-16by9">
                  <iframe class="embed-responsive-item" src="baptismal-changes-otherperson-pdf.php?AUTONUM=<?=$_POST['AUTONUM'];?>" allowfullscreen></iframe>
                </div>
