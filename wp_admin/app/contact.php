            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
				        	<?php
                    $sql = "SELECT * FROM tbl_contact ORDER BY PROVIDER ASC";
                    ...
                    while($row = $query->fetch_assoc()){
                      ?>
                        <tr>
                          ...
                          <td align="right">
                          <div class="btn-group">
                            <button data-id="<?php echo $row['ID'];?>"  class="btn bg-success btn-sm edit"><i class="fa-solid fa fa-edit"></i> </button>
...
function getRow(id){
  $.ajax({
    ...
    success: function(response){
      $('.id').val(response.ID);
      $('.del_provider').html(response.PROVIDER);
      $('.del_mobileno').html(response.MOBILENO);
      $('#edit_provider').val(response.PROVIDER);
      $('#edit_mobileno').val(response.MOBILENO);
