...
if(isset($EDIT)){
    $sql = "SELECT * FROM tbl_baptismal_changes WHERE ID= '".$EDIT."'";
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h4>Edit Changes Certificate <a href="baptismal-changes-own-record.php" class="btn bg-maroon btn-xs"><i class="fa fa-sharp fa-solid fa-left"></i> Back</a></h4>
          </div>
          <div class="col-sm-6">
		  ...
		  <?php
			  ...
			  <div class="card card-default">
                    <div class="card-header">
                      ...
                      <div class="card-body">
					  <form class="form-horizontal" method="POST" action="baptismal-changes-own-update-save.php?return=<?php echo basename($_SERVER['PHP_SELF']); ?>" enctype="multipart/form-data">
          		  <div class="row">
                         <div class="col-sm-6">
				  ...
				  <div class="col-sm-4">
					...
					<div class="col-sm-6">
                    		...
                    		<textarea rows="8" class="form-control text-capitalize" name="SPONSOR" value="<?=$SPONSOR;?>"></textarea>
                  		</div>
                	</div>
					...
					<div class="col-sm-6">
          		  		<div class="form-group">
							<span>and not </span>
                    		<textarea rows="8" class="form-control text-capitalize" name="NOT_SIX" value="<?=$NOT_SIX;?>" readonly></textarea>
                  		</div>
                	</div>
