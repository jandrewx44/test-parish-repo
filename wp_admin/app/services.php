        ...
        <div class="row mb-2">
          <div class="col-12">
            <div class="btn-group btn-group-sm" role="group" aria-label="Manage filters">
              ...
              <a href="services.php?home=services" class="btn btn-primary text-white">Services</a>
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                      <h3 class="card-title"> 
              <button href="#_add_modal" data-toggle="modal" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> SERVICES</button>
              </h3>
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped table-sm text-sm">
                  ...
                  <tbody>
				        	<?php
                    $sql = "SELECT * FROM tbl_services ORDER BY SERVICES ASC";
