        ...
        <div class="row mb-2">
          <div class="col-12">
            <div class="btn-group btn-group-sm" role="group" aria-label="Appointment filters">
              ...
              <a href="appointment_rejected.php?home=appointment_rejected" class="btn btn-primary text-white">Rejected</a>
            ...
            <div class="card">
             ...
             <h3 class="card-title"> 
              ...
              <div class="card-tools">
                <form id="deleteAllFormRejected" method="POST" action="appointment_delete_all.php" style="display:inline">
                  <input type="hidden" name="status" value="Rejected">
                  <input type="hidden" name="return" value="appointment_rejected.php?home=appointment_rejected">
                  <button type="button" class="btn btn-danger btn-sm" id="delete_all_btn_rejected"><i class="fa fa-trash"></i> DELETE ALL</button>
                </form>
...
<script type="text/javascript">
  ...
  document.getElementById('delete_all_btn_rejected').addEventListener('click', function(){
    Swal.fire({
      title: 'Delete All Rejected?',
      text: 'This will permanently delete all rejected appointments.',
      icon: 'warning',
      ...
      if (result.isConfirmed) {
        document.getElementById('deleteAllFormRejected').submit();
      }
    });
  });
</script> 
