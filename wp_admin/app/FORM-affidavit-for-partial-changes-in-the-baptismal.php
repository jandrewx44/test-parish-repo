...
if($query->num_rows > 0){
    ...
    <table cellpadding="0" width="100%" border="0" style="border-collapse: collapse">
      ...
      <tbody>
		...
		<tr>
			<td width="32%">My Name shall now be </td>
			<td width="30%" style="border-bottom:0.1px solid black;"></td>
			<td width="8%"> and not </td>
			<td width="30%" style="border-bottom:0.1px solid black;"></td>
		</tr>
		<tr>
			<td width="32%">My Place of Birth shall now be </td>
			<td width="30%" style="border-bottom:0.1px solid black;"></td>
			<td width="8%"> and not </td>
			<td width="30%" style="border-bottom:0.1px solid black;"></td>
		</tr>
		<tr>
			<td width="32%">My Date of Birth shall now be </td>
			<td width="30%" style="border-bottom:0.1px solid black;"></td>
			<td width="8%"> and not </td>
			<td width="30%" style="border-bottom:0.1px solid black;"></td>
		</tr>
		<tr>
			<td width="32%">My Father’s Name shall now be </td>
			<td width="30%" style="border-bottom:0.1px solid black;"></td>
			<td width="8%"> and not </td>
			<td width="30%" style="border-bottom:0.1px solid black;"></td>
		</tr>
		<tr>
			<td width="32%">My Mother’s Name shall now be </td>
			<td width="30%" style="border-bottom:0.1px solid black;"></td>
			<td width="8%"> and not </td>
			<td width="30%" style="border-bottom:0.1px solid black;"></td>
		</tr>
		<tr>
			<td width="32%">My Sponsors shall now be </td>
			<td width="30%" style="border-bottom:0.1px solid black;"></td>
			<td width="8%"> and not </td>
			<td width="30%" style="border-bottom:0.1px solid black;"></td>
		</tr>
	  ...
	  <tr>
		...
		<tr>
			...
			<td width="50%" align="center"><br><br><br><br><br><br><div style="text-align:center; border-top:1px solid black; width:100%; margin:auto; font-family:Times; font-size:13px; padding-top:5px;">'.$PRIEST_NAME.'</div></td>
		</tr>
	  </tfoot>
    </table>
    ...
    ob_end_clean();
    $pdf->Output('FORM-affidavit-for-partial-changes-in-the-baptismal.pdf', 'D');
