...
class MYPDF extends TCPDF {
  ...
  public function Footer() {
    ...
    $pdf->SetTitle('Permision Baptism Record');  
...
if($query->num_rows > 0){
  ...
  <table width="100%" border="0" style="text-align:justify">
   <thead>
    <tr><td><hr></td></tr>
    <tr><td><h1 align="center" style="font-size:22pt;font-family:">PERMISSION FOR BAPTISM</h1><br></td></tr>
    <tr><td><br><br><br></td></tr>
    <tr><td width="100%"><h4 align="right">Date: _____________</h4><br></td></tr>
   </thead>
  <tbody>
  <tr>
  <td width="100%"><br></td>
  ...
  <td width="100%"><br><br><br></td>
   ...
   <tr>
   <td width="50%">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;This is to respectfully grant our parishioner, </td>
   <td width="40%" style="border-bottom:0.1px solid black;"></td>
   <td width="10%">to have</td>
 </tr>
 <tr>
    <td width="30%">the baptism of his/ her child </td>
    <td width="40%" style="border-bottom:0.1px solid black;"></td>
    <td width="30%">administered in your Church.</td>
  </tr>
  <tr>
  <td width="100%"><br></td>
</tr>
 <tr>
      <td width="100%">Please do the necessary things that need to be done so the said parishioner complies with the requirements prescribed in the Code of Canon Law and our Diocesan Statutes. </td>
   </tr>
 ...
 <td width="100%"><br></td>
    ...
    <tr>
      <td width="30%">Given at the Parish Office this </td>
      <td width="10%" style="border-bottom:0.1px solid black;"></td>
      <td width="8%">day of </td>
      <td width="19%" style="border-bottom:0.1px solid black;"></td>
      <td width="3%">,</td>
  ...
  <td width="100%"><br><br><br><br><br><br><br><br><br><br><br><br></td>
    ...
    ob_end_clean();
    $pdf->Output('permission-for-BAPTISM.pdf', 'D');
