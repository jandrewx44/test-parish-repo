        ...
        <div class="row mb-2">
          <div class="col-12">
            <div class="btn-group btn-group-sm" role="group" aria-label="Manage filters">
              ...
              <a href="requirements.php?home=requirements" class="btn btn-primary text-white">Requirements</a>
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                      <h3 class="card-title"> 
              <button href="#_add_modal" data-toggle="modal" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> REQUIREMENTS</button>
              </h3>
