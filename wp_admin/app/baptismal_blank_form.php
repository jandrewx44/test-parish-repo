...
<h4 align="">This is to certify that</h4>
  <table style="width:100%" border="0">
    <tr >
      ...
      <td><div style="border-bottom:1px solid #000;color:#fff">Andres P. Jario</div></td>
    </tr>
    <tr>
      <td>Date of Birth</td>
      <td><div style="border-bottom:1px solid #000;color:#fff">May 10, 1990</div></td>
    </tr>

    <tr>
        <td>Name of Father</td>
        <td><div style="border-bottom:1px solid #000;color:#fff">Andres V. Jario Sr.</div></td>
    </tr>

    <tr>
        <td>Maiden Name of Mother</td>
        <td><div style="border-bottom:1px solid #000;color:#fff">Tresa B. Pausal</div></td>
    </tr>
    <tr>
        <td>Address of Parents</td>
        <td><div style="border-bottom:1px solid #000;color:#fff">Pantao Dipolog Zamboanga del Norte</div></td>
    </tr>
  </table>
  ...
  <table style="width:100%" border="0">
    <tr>
      ...
      <td style="color:#fff">Name of Parish</td>
    </tr>
    <tr>
      <td>Address of Parish: </td>
      <td style="color:#fff">Address of Parish</td>
    </tr>
  </table>
<br>
  <table style="width:100%" border="0">
    <tr>
      ...
      <td><div style="border-bottom:1px solid #000;color:#fff">Date of Baptism</div></td>
    </tr>
    <tr>
      <td>Baptized By</td>
      <td><div style="border-bottom:1px solid #000;color:#fff">Name of Priest</div></td>
    </tr>
        <tr>
        ...
        <td></td>
        <td style="color:#fff">
        <div style="width:100%;height:60px;border:1px solid #fff">
        <ol>
