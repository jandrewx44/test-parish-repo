              ...
              <div class="row">
				...
				$currenturl="http://".$_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI'];
				 if (isset($_GET['page_no']) && $_GET['page_no']!="") {
					...
					$news = "SELECT DATE_FORMAT(DATE_CONFIRMED, '%Y') As tDate, COUNT(*) As tTotal FROM tbl_confirmation GROUP BY tDate ORDER BY tDate DESC LIMIT $offset, $total_records_per_page"; 
