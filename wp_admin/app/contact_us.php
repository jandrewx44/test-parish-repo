...
<div class="wrapper">
        ...
        <div class="row mb-2">
          <div class="col-12">
            <div class="btn-group btn-group-sm" role="group" aria-label="Manage filters">
              ...
              <a href="contact_us.php?home=contactus" class="btn btn-primary text-white">Inquiries</a>
            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
				        	<?php
                    $stmt=$conn->prepare("SELECT * FROM tbl_contact_us ORDER BY C_DATE DESC");
                    if($stmt->execute()){
				        	  $cnt=1;
                    ...
                    while($row = $result->fetch_assoc()){
                      ?>
                        <tr>
                          ...
                          <td align="right">
                          <div class="btn-group">
                            <button data-cid="<?=$row['C_ID'];?>" data-message="<?=$row['C_MESSAGE'];?>" data-name="<?=$row['C_NAME'];?>" onclick="delCotactn(this);"  class="btn bg-maroon btn-sm delete"><i class="fa-solid fa fa-trash"></i> </button>
                           </div>
                          </td>
                        </tr>
                      <?php
 ...
 <script>
  function delCotactn(self){
    ...
    document.getElementById("del_message").innerHTML=message;
