...
ob_start();
  ...
  $AUTONUM =$_GET['AUTONUM'];
   //$sql = "SELECT * FROM tbl_baptismal_otherperson a INNER JOIN tbl_baptismal b ON a.UNDERSIGNED=b.ID WHERE a.AUTONUM= '".$AUTONUM."'";
     $sql = "SELECT * FROM tbl_baptismal_otherperson WHERE AUTONUM= '".$AUTONUM."'";
