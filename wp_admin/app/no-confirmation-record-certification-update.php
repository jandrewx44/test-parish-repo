...
if(isset($NOCONID)){
	...
	if($query->num_rows > 0){
		...
		$NOCONID   	=mysqli_real_escape_string($conn,($smtrow['NOCONID']));
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h4>Edit Certificate <a href="no-confirmation-record-certification-record.php" class="btn bg-maroon btn-xs"><i class="fa fa-sharp fa-solid fa-left"></i> Back</a></h4>
          </div>
          <div class="col-sm-6">
        ...
        <div class="row">
		  ...
		  <?php
			  ...
			  <div class="card card-default">
					...
					<form class="form-horizontal" method="POST" action="no-confirmation-record-certification-update-save.php?return=<?=basename($_SERVER['PHP_SELF']); ?>" enctype="multipart/form-data">
                      <div class="card-body">
						<div class="row">
						<input type="hidden" name="NOCONID" value="<?=$NOCONID;?>" required> 
