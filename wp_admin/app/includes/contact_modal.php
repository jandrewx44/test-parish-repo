            	...
            	<form class="form-horizontal" method="POST" action="contact_add.php?return=<?php echo basename($_SERVER['PHP_SELF']); ?>" enctype="multipart/form-data">
                    ...
                    <div class="col-sm-12">
                       <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="PROVIDER" placeholder ="PROVIDER" required>
                        </div>
                    </div>
                    <div class="col-sm-12">
                       <div class="form-group">
                             <label for="lastname" class="control-label">MOBILE NO</label>
                            <input type="text" maxlength="11" class="form-control" name="MOBILENO" placeholder ="MOBILE NO" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"  required>
                        </div>
                    </div>
...
<div class="modal fade" id="edit">
    <div class="modal-dialog">
        <div class="modal-content">
          	...
          	<div class="modal-body">
            	<form class="form-horizontal" method="POST" action="contact_edit.php?return=<?php echo basename($_SERVER['PHP_SELF']); ?>" enctype="multipart/form-data">
          		  <div class="row">
                    <div class="col-sm-12">
                       <div class="form-group">
                             <label for="lastname" class="control-label">PROVIDER</label>
                    ...
                    <div class="col-sm-12">
                       <div class="form-group">
                             <label for="lastname" class="control-label">MOBILE NO</label>
                            <input type="text" maxlength="11" class="form-control" id="edit_mobileno" name="MOBILENO" placeholder ="MOBILE NO" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"  required>
                        </div>
                    </div>
                </div><!----row-->
          	</div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="submit" name="submit" class="btn btn-danger btn-sm"><i class="fa fa-thrash"></i> <span class="fa fa-trash"></span>  Yes</button>
            </div>
            </form>
        </div>
    </div>
