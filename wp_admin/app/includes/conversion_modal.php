...
<div class="modal fade " id="add" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
			  ...
			  <h4 class="modal-title"><span class="fa fa-plus"></span> CONVERSION REGISTER</h4>
			  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
				<span aria-hidden="true">&times;</span>
			  </button>
			</div>
          	<div class="modal-body">
            	<form class="form-horizontal" method="POST" action="conversion_add.php" enctype="multipart/form-data">
          		  <div class="row">
				<div class="col-sm-4">
				...
				<div class="col-sm-4">
          		  <div class="form-group">
                  	<label for="firstname" class="control-label">DATE OF RITE</label>
                    	<input type="date" class="form-control" name="DATE_OF_RITE" placeholder="Date of Rite">
                  	</div>
                </div>
				...
				<div class="col-sm-8">
          		  <div class="form-group">
                  	<label for="firstname" class="control-label">PLACE OF RECEPTION</label>
                    	<input type="text" class="form-control" name="PLACE_OF_RECEPTION" placeholder="Place of Reception">
                  	</div>
                </div>
                ...
                <div class="form-group">
                      ...
                      <input type="text" class="form-control " name="MINISTER" placeholder="Priest Name">
                  	</div>
                </div>
                <div class="col-sm-4">
          		  <div class="form-group">
                ...
                <div class="form-group">
					  ...
					  <input type="text" class="form-control" name="DENOMINATION" placeholder="Denomination">
                  	</div>
                </div>
				<div class="col-sm-12">
          		  <div class="form-group">
...
<div class="modal fade" id="search_conversion" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
          	<div class="modal-header">
          	...
          	<div class="modal-body">
            	<form class="form-horizontal" method="GET" action="conversion_info_search_result.php" enctype="multipart/form-data">
          		  <div class="row">
					<div class="col-sm-12">
          		  <div class="form-group">
					  <select name="search" type="text" class="form-control select2" data-dropdown-css-class="select2-maroon" class="form-control select2" required>
								...
								<?php
									$sql ="SELECT * FROM tbl_conversion ORDER BY CHILD_NAME ASC";
									$smt = $conn->query($sql);
									if($smt->num_rows >0){
...
<div class="modal fade" id="delete_all_conversion" data-backdrop="static" data-keyboard="false">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
              <div class="text-center">
                  <p>ARE YOU SURE YOU WANT TO DELETE ALL CONVERSION RECORDS?</p>
                  <h4 class="text-danger"><i class="fas fa-exclamation-triangle"></i> This action cannot be undone!</h4>
              </div>
            </div>
            <div class="modal-footer">
              <button type="button" class="btn btn-default btn-sm pull-left" data-dismiss="modal"><i class="fa fa-times"></i> CANCEL</button>
              <form action="conversion_delete_all.php" method="POST">
