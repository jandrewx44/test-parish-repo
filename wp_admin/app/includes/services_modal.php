...
<div class="modal fade" id="_add_modal" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
			  ...
			  <h4 class="modal-title"><span class="fa fa-plus"></span> SERVICES</h4>
			  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
				<span aria-hidden="true">&times;</span>
			  </button>
			</div>
            <form class="form-horizontal needs-validation" action="services_add.php" method="POST"  autocomplete="off" enctype="multipart/form-data" novalidate>
            <div class="modal-body">
          		  <div class="row main-form">
                    <div class="col-sm-12">
                    <label for="lastname" class="control-label font-weight-normal">SERVICES</label>
...
<div class="modal fade" id="edit_modal" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
          	<div class="modal-header">
			  <h4 class="modal-title"><span class="fa fa-edit"></span> SERVICES</h4>
			  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
				<span aria-hidden="true">&times;</span>
			  </button>
			</div>
            <form class="form-horizontal submit-livelihood-validation" action="services_edit.php" method="POST"  autocomplete="off" enctype="multipart/form-data" novalidate>
            <div class="modal-body">
                <input type="hidden" id="edit_reqid" name="DID" required>
          		  <div class="row">
                    <div class="col-sm-12">
                    <label for="lastname" class="control-label font-weight-normal">SERVICES</label>
                      <input type="text" class="form-control" id="edit_reqname" name="SERVICES" required>    
                    </div>
                </div><!----row-->
          	</div>
          	<div class="modal-footer">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body text-center">
                 <input type="hidden" id="del_reqid" name="DID">
