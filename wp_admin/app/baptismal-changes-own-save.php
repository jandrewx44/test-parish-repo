...
$AUTONUM=date('Ymd').generateRandomString();
	...
	if(isset($_POST['baptism_changes_submit'])){			
		
        $UNDERSIGNED   	=$_POST['UNDERSIGNED'];
		...
		$sql= "INSERT INTO tbl_baptismal_changes(UNDERSIGNED, RESIDING, REGNO, PAGENO, SERIESNO, NAME_NOWBE, NOT_ONE, POB, NOT_TWO, DOB, NOT_THREE, FATHERNAME, NOT_FOUR, MOTHERNAME, NOT_FIVE, SPONSOR, NOT_SIX, BIRTH_CERT, JOINT_AFFIDAVIT, MARRIAGE_CONTRACT_PARENTS, CERT_OF_BAPTISM, OTHERS, THIS, OF, YEAR, PETITIONER,AUTONUM,DATE_ISSUED) VALUES('$UNDERSIGNED','$RESIDING','$REG_NO','$PAGE_NO','$SERIES_OF','$NAME_NOWBE','$NOT_ONE','$POB','$NOT_TWO','$DOB','$NOT_THREE','$FATHER_NAME','$NOT_FOUR','$MOTHER_NAME','$NOT_FIVE','$SPONSOR','$NOT_SIX','$BIRTH_CERT','$JOINT_AFFIDAVIT','$MARRIAGE_CONTRACT_PARENTS','$CERT_OF_BAPTISM','$OTHERS','$THIS','$OF','$YEAR','$PETITIONER','$AUTONUM','$DATE_ISSUED')";
			if($conn->query($sql)){
