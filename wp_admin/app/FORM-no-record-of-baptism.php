...
if($query->num_rows > 0){
  ...
  <table width="100%" border="0" style="text-align:justify">
   <thead>
    <tr><td><hr></td></tr>
    <tr><td><h1 align="center" style="font-size:22pt">CERTIFICATION</h1><br></td></tr>
  ...
  <tbody>
   ...
   <tr>
      <td width="100%">record of BAPTISM in our parish, hence we cannot issue upon a certificate of baptism as humbly requested.</td>
   </tr>
   <tr>
 ...
 <td width="100%"><br><br></td>
  ...
  <td width="100%"><br><br><br><br><br><br><br><br><br><br><br><br></td>
    ...
    ob_end_clean();
    $pdf->Output('No Baptism Record-.pdf', 'D');
