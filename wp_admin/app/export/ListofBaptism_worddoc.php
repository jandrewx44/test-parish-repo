...
$sql ="SELECT `RECORD_NUMBER`, `CHILD_NAME`, `GENDER`, `DATE_OF_BIRTH`, `PLACE_OF_BIRTH`, `FATHER_NAME`, `MOTHER_NAME`, `NAME_OF_PRIEST`, `NAME_OF_CHURCH`, `DATE_CREATED` FROM `tbl_baptismal` ORDER BY CHILD_NAME ASC";
